...
决定一切的，是内心中的流动性。研究中的好奇与思路的流动，运动中身体的协调与节奏的流动，音乐中呼吸与旋律的流动。它们的共同点在于：只有学会顺势而为，而不是费力拉扯，平衡才会出现。真正的挑战是如何学会去收力，而不是去盲目发力。在直接的目标上过度用力会陷在一个错误的平衡中。真正的掌控，来自紧张中恰到好处的放松，而不是更大的用力。尊重事物本身的规律，以其中优美的流动性为向导，当用在正确的基本上方法的努力达到时，结果会自然出现 — 水到渠成。至道常隐于形外。
